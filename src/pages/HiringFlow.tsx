            ...
            <div className="max-w-6xl mx-auto animate-fade-in">
              <div className="mb-6">
                ...
                <p className="text-muted-foreground">
                  Define the role clearly so AI can help you screen candidates
                  effectively
                </p>
              </div>
              ...
              {!isStep1Valid && (
                <div className="mb-6 p-4 bg-warning/10 border border-warning/20 rounded-xl flex items-center gap-3">
                  ...
                  <p className="text-sm text-foreground">
                    Fill in Role Name, Responsibilities, and Must-Have Skills to
                    continue
                  </p>
                </div>
              )}
              ...
              {isStep1Complete && (
                <div className="mb-6 p-4 bg-success/10 border border-success/20 rounded-xl flex items-center gap-3">
                  ...
                  <p className="text-sm text-foreground">
                    Job description saved! You can edit or continue to resume
                    screening.
                  </p>
                </div>
              )}
                ...
                <div className="space-y-6">
                  ...
                  {generatedJD && (
                    <GeneratedJDDisplay
                      data={generatedJD}
                      onRegenerate={() =>
                        generationType && handleGenerateJD(generationType)
                      }
          ...
          {currentStep === 2 && (
            <div className="max-w-6xl mx-auto animate-fade-in">
              <div className="mb-6">
                ...
                <p className="text-muted-foreground">
                  Upload resumes and get AI-powered analysis based on your job
                  requirements
                </p>
              </div>
              ...
              <div className="mb-6 p-4 bg-muted rounded-xl">
                <p className="text-sm text-muted-foreground">
                  ...
                  {shortlistedCount === 0 &&
                    " — Shortlist at least one to continue"}
                </p>
              </div>
